            ...
            <div className="relative">
              <BrowserFrame url="shimi.bapita.com" accent="#d4622a">
                <div className="bg-white px-6 py-7">
                  ...
                  <blockquote className="mt-6 border-l-2 border-book/30 pl-4 text-[0.9375rem] italic leading-relaxed text-espresso/40">
                    First shop on Bapita Book.
                  </blockquote>

                  <div className="mt-6 flex items-center gap-2 rounded-pill bg-success/10 px-3.5 py-2">
                    <span className="h-1.5 w-1.5 rounded-full bg-success" />
                    <span className="text-[0.75rem] font-bold text-success">
                      Booking page live
                    </span>
                  </div>
                </div>
