...
/** Clay palettes per falafel — amber / terracotta / emerald / azure.
 * Social carries the terracotta of the Social platform; Book takes the amber. */
  ...
  return (
    <div data-bowl className={className} style={style}>
      <div className="relative size-full">
        ...
        <div
          className="absolute left-0 right-0 top-0 overflow-hidden rounded-full"
          style={{
            height: "19%",
            background:
